...
for scenario in interactive_scenarios:
    with open(f"./P3VI/data/car_dump/{scenario}.npy", "rb") as f:
        ...
        np.save(f"./P3VI/data/new_car/{scenario}_cleaned.npy", arr, allow_pickle=False)
    ...
    with open(f"./P3VI/data/car_dump/{scenario}_car.npy", "rb") as f:
        arr = np.load(f, allow_pickle=True)
        ...
        plt.show()
        np.save(f"./P3VI/data/new_car/{scenario}_cleaned_car.npy", arr, allow_pickle=False)
...
# np.save(f"./P3VI/data/new_car/all_int.npy", all_int, allow_pickle=True)
# np.save(f"./P3VI/data/new_car/all_non_int.npy", all_non_int, allow_pickle=True)
# np.save(f"./P3VI/data/new_car/all_int_car.npy", all_int_car, allow_pickle=True)
# np.save(f"./P3VI/data/new_car/all_non_int_car.npy", all_non_int_car, allow_pickle=True)
