...
class SocialCi3pWrapperV2:
    ...
    def __init__(self, path=None):
        ...
        self.logger.info(f"Model: SocialCi3pWrapperV2")
        ...
        self.model = SocialCi3pV2(n_obs, n_pred).cuda()
...
if __name__ == '__main__':
    # abw = SocialCi3pWrapperV2()
    # abw.train()

    abw_eval = SocialCi3pWrapperV2(path="./_out/SocialCi3pWrapperV2/obs60_pred80/2024-07-08_11-40-00/model_124.pth")
