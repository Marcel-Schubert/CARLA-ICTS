...
from CI3PP.SocialNoCar.model import SocialCi3pNoCar
...
class SocialCi3pWrapperV2NoCar:
    ...
    def __init__(self, path=None):
        ...
        self.logger.info(f"Model: SocialCi3pWrapperV2NoCar")
        ...
        self.model = SocialCi3pNoCar(n_obs, n_pred).cuda()
...
if __name__ == '__main__':
    # abw = SocialCi3pWrapperV2NoCar()
    # abw.train()

    abw_eval = SocialCi3pWrapperV2NoCar(path="./_out/SocialCi3pWrapperV2NoCar/obs60_pred80/2024-07-09_16-10-52/model_116.pth")
