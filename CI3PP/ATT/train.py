...
class CI3PP_ATT_Wrapper:
    def __init__(self, model_path=None,
        ...
        self.model = CI3P_ATT(n_obs, n_pred).cuda()
        ...
        export_dir = './_out/weights/CI3P_ATT/'
        self.save_path = (f'{export_dir}/CI3P_ATT'
    ...
    def train(self):
        ...
        for epoch in range(epochs):
            ...
            if epoch - last_best_epoch > 10:
                telegram_bot_sendtext(f"CI3P ATT training stopped, no improvement in 10 epochs at epoch {epoch}\nEvalLoss: {best_eval}\nFDELoss: {best_eval_fde}")
