...
from CI3PP.CVAE_ATT_SH.model import CI3PP_CVAE_ATT_SH
...
class CI3PP_CVAE_ATT_WRAPPER_SH:
    def __init__(self, model_path=None,observed_frame_num=observed_frame_num,predicting_frame_num=predicting_frame_num):
        self.model = CI3PP_CVAE_ATT_SH(latent_dim=latent_dim, predict_frames=predicting_frame_num).cuda()
        if model_path:
        ...
        export_dir = './_out/weights/CI3PP_CVAE_ATT_SH'
        self.save_path = (f'{export_dir}/CI3PP_CVAE_ATT_SH'
    ...
    def train(self):
        ...
        last_best_epoch = 0
        telegram_bot_sendtext("CI3P ATT BH training started")
        ...
        for epoch in range(epochs):
            ...
            if epoch - last_best_epoch > 10:
                telegram_bot_sendtext(f"CI3P CVAE ATT SH training stopped, no improvement in 10 epochs at epoch {epoch}\nEvalLoss: {best_eval}\nFDELoss: {best_eval_fde}")
...
if __name__ == "__main__":
    model = CI3PP_CVAE_ATT_WRAPPER_SH()
    model.train()
