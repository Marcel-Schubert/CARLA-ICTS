...
from CI3PP.SocialV3CVAE.model import SocialCi3pV3CVAE
import logging
import os
import time
import numpy as np
...
class SocialCi3pWrapperV3CVAE:
    ...
    def __init__(self, path=None):
        ...
        #
        # self.logger.info(f"Model: SocialCi3pWrapperV3CVAE")
        ...
        self.model = SocialCi3pV3CVAE(n_obs, n_pred).cuda()
...
if __name__ == '__main__':
    # abw = SocialCi3pWrapperV3CVAE()
    # abw.train()

    abw_eval = SocialCi3pWrapperV3CVAE(path="./_out/SocialCi3pWrapperV3CVAE/obs15_pred20/2024-07-15_00-32-15/model_140.pth")
