...
from CI3PP.Social.model import SocialCi3p
...
class SocialCi3pWrapper:
    ...
    def __init__(self, path=None):
        ...
        self.logger.info(f"Model: SocialCi3pWrapper")
        ...
        self.model = SocialCi3p(n_obs, n_pred).cuda()
...
if __name__ == '__main__':
    # abw = SocialCi3pWrapper()
    # abw.train()

    abw_eval = SocialCi3pWrapper(path="./_out/SocialCi3pWrapper/obs60_pred80/2024-07-05_00-01-05/model_160.pth")
