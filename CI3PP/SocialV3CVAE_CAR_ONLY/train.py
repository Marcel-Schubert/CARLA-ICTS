...
from CI3PP.SocialV3CVAE_CAR_ONLY.model import SocialCi3pV3CVAE_DUO
import logging
import os
import time
import numpy as np
...
class SocialCi3pWrapperV3CVAE_CAR_ONLY:
...
if __name__ == '__main__':
    # abw = SocialCi3pWrapperV3CVAE_CAR_ONLY()
    # abw.train()

    abw_eval = SocialCi3pWrapperV3CVAE_CAR_ONLY(path="./_out/SocialCi3pWrapperV3CVAE_CAR_ONLY/obs15_pred20/2024-07-15_00-32-30/model_1.pth")
