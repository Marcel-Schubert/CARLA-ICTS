...
from CI3PP.SocialNoCog.model import SocialCi3pNoCog
...
class SocialCi3pWrapperV2NoCog:
    ...
    def __init__(self, path=None):
        ...
        self.logger.info(f"Model: SocialCi3pWrapperV2NoCog")
        ...
        self.model = SocialCi3pNoCog(n_obs, n_pred).cuda()
...
if __name__ == '__main__':
    # abw = SocialCi3pWrapperV2NoCog()
    # abw.train()

    abw_eval = SocialCi3pWrapperV2NoCog(path="./_out/SocialCi3pWrapperV2NoCog/obs60_pred80/2024-07-09_16-11-19/model_127.pth")
