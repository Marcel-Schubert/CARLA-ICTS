...
from CI3PP.SocialV3CVAE_COG_ONLY.model import SocialCi3pV3CVAE_DUO
import logging
import os
import time
import numpy as np
...
from CI3PP.SocialV2.model import SocialCi3pV2
...
class SocialCi3pWrapperV3CVAE_COG_ONLY:
    ...
    def __init__(self, path=None):
        ...
        self.model = SocialCi3pV3CVAE_DUO(n_obs, n_pred).cuda()
...
if __name__ == '__main__':
    # abw = SocialCi3pWrapperV3CVAE_COG_ONLY()
    # abw.train()

    abw_eval = SocialCi3pWrapperV3CVAE_COG_ONLY(path="./_out/SocialCi3pWrapperV3CVAE_COG_ONLY/obs15_pred20/2024-07-15_00-34-58/model_174.pth")

    dl = singleDatasets(("./P3VI/data/new_car/01_int_cleaned.npy", "./P3VI/data/new_car/01_int_cleaned_car.npy"), n_obs, n_pred, 512)
    int_1_a, int_1_f = abw_eval.eval(dl)
    print(f"\nINT-1 {int_1_a:.4f} {int_1_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/02_int_cleaned.npy", "./P3VI/data/new_car/02_int_cleaned_car.npy"), n_obs, n_pred, 512)
    int_2_a, int_2_f = abw_eval.eval(dl)
    print(f"\nINT-2 {int_2_a:.4f} {int_2_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/03_int_cleaned.npy", "./P3VI/data/new_car/03_int_cleaned_car.npy"), n_obs, n_pred, 512)
    int_3_a, int_3_f = abw_eval.eval(dl)
    print(f"\nINT-3 {int_3_a:.4f} {int_3_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/04_int_cleaned.npy", "./P3VI/data/new_car/04_int_cleaned_car.npy"), n_obs, n_pred, 512)
    int_4_a, int_4_f = abw_eval.eval(dl)
    print(f"\nINT-1 {int_4_a:.4f} {int_4_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/05_int_cleaned.npy", "./P3VI/data/new_car/05_int_cleaned_car.npy"), n_obs, n_pred, 512)
    int_5_a, int_5_f = abw_eval.eval(dl)
    print(f"\nINT-5 {int_5_a:.4f} {int_5_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/06_int_cleaned.npy", "./P3VI/data/new_car/06_int_cleaned_car.npy"), n_obs, n_pred, 512)
    int_6_a, int_6_f = abw_eval.eval(dl)
    print(f"\nINT-6 {int_6_a:.4f} {int_6_f:.4f}")

    # print("\npure test", abw_eval.eval(abw_eval.test_loader))

    dl = singleDatasets(("./P3VI/data/new_car/01_non_int_cleaned.npy", "./P3VI/data/new_car/01_non_int_cleaned_car.npy"), n_obs, n_pred, 512)
    non_int_1_a, non_int_1_f = abw_eval.eval(dl)
    print(f"\nNON-INT-1 {non_int_1_a:.4f} {non_int_1_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/02_non_int_cleaned.npy", "./P3VI/data/new_car/02_non_int_cleaned_car.npy"), n_obs, n_pred, 512)
    non_int_2_a, non_int_2_f = abw_eval.eval(dl)
    print(f"\nNON-INT-2 {non_int_2_a:.4f} {non_int_2_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/03_non_int_cleaned.npy", "./P3VI/data/new_car/03_non_int_cleaned_car.npy"), n_obs,n_pred, 512)
    non_int_3_a, non_int_3_f = abw_eval.eval(dl)
    print(f"\nNON-INT-3 {non_int_3_a:.4f} {non_int_3_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/04_non_int_cleaned.npy", "./P3VI/data/new_car/04_non_int_cleaned_car.npy"), n_obs,n_pred, 512)
    non_int_4_a, non_int_4_f = abw_eval.eval(dl)
    print(f"\nNON-INT-4 {non_int_4_a:.4f} {non_int_4_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/05_non_int_cleaned.npy", "./P3VI/data/new_car/05_non_int_cleaned_car.npy"), n_obs,n_pred, 512)
    non_int_5_a, non_int_5_f = abw_eval.eval(dl)
    print(f"\nNON-INT-5 {non_int_5_a:.4f} {non_int_5_f:.4f}")

    dl = singleDatasets(("./P3VI/data/new_car/06_non_int_cleaned.npy", "./P3VI/data/new_car/06_non_int_cleaned_car.npy"), n_obs,n_pred, 512)
