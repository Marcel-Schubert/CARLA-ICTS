...
from sweep.ATT_RL.model import CI3P_ATT_RL
...
def run_sweep():
    run = wandb.init()
    wandb.alert(title='New Sweep Run CI3P ATT RL',
...
if __name__ == '__main__':
    wandb.agent('carla-icts-pagi/CI3P ATT RL/pc9m5dsc', function=run_sweep)
