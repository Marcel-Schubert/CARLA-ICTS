...
from sweep.ATT_BH_NOX.model import CI3P_ATT_BH_NOX
...
def run_sweep():
    run = wandb.init()
    wandb.alert(title='New Sweep Run (CI3P_ATT_BH_NOX)',
...
if __name__ == '__main__':
    wandb.agent('carla-icts-pagi/CI3P ATT BH NOX/fdcrexuc', function=run_sweep)
