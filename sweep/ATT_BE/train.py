...
from sweep.ATT_BE.model import CI3P_ATT_BE
...
def run_sweep():
    ...
    wandb.alert(title='New Sweep Run',
                text=f'Starting new sweep run for CI3P-ATT-BE with config: {run.config}',
...
if __name__ == '__main__':
    wandb.agent('carla-icts-pagi/"CI3P ATT BE"/x3404fxn', function=run_sweep)