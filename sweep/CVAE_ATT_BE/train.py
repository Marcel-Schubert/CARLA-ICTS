...
from sweep.CVAE_ATT_BE.model import CI3PP_CVAE_ATT_BE
...
def run_sweep():
    run = wandb.init()
    wandb.alert(title='New Sweep Run (CI3PP_CVAE_ATT_BE)',
...
if __name__ == '__main__':
    wandb.agent('carla-icts-pagi/CI3P CVAE ATT BE/yiv4cg0w', function=run_sweep)
