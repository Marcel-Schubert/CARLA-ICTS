...
if __name__ == '__main__':
    ...
    # abw_eval = M2P3Wrapper(path="./_out/M2P3Wrapper/obs60_pred80/2024-07-10_19-00-24/model_82.pth")
    abw_eval = M2P3Wrapper(path="./_out/M2P3Wrapper/obs15_pred20/2024-07-15_00-15-42/model_32.pth")
