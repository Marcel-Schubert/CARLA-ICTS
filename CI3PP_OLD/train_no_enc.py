...
from CI3PP.model_nod_enc import CI3PP_NO_ENC
...
path_non_int = ".. 00/P3VI/data/ICTS2_non_int.npy"
...
class CI3PPWrapper_NO_ENC:
    def __init__(self, model_path=None,
                 n_obs=observed_frame_num,
                 n_pred=predicting_frame_num):
        self.model = CI3PP_NO_ENC(observed_frame_num, predicting_frame_num).cuda()
        ...
        export_dir = './_out/weights/CI3PP_no_enc'
        self.save_path = (f'{export_dir}/CI3PP_no_enc'
