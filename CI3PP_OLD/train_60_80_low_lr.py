...
class CI3PPWrapper:
    def __init__(self, model_path=None,
        ...
        self.model = CI3PP(n_obs, n_pred).cuda()

        if model_path:
            self.model.load_state_dict(torch.load(model_path))

        self.optim = torch.optim.Adam(lr=0.00001, params=self.model.parameters(), weight_decay=0.0001)


        export_dir = './_out/weights/CI3PP_SUM'
        self.save_path = (f'{export_dir}/CI3PP_sum_'
