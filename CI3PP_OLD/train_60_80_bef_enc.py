...
from CI3PP.model_bef_enc import CI3PP_BEF_ENC
...
class CI3PPWrapper_BEF_ENC:
    def __init__(self, model_path=None,
        ...
        self.model = CI3PP_BEF_ENC(n_obs, n_pred).cuda()
        ...
        export_dir = './_out/weights/CI3PP_BEF_ENC'
        self.save_path = (f'{export_dir}/CI3PP_bef_enc_'
